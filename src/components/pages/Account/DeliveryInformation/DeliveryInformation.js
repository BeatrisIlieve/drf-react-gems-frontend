...
export const DeliveryInformation = () => {
  return (
    <section className={styles["delivery-info"]}>
      ...
      <div className={styles["delivery-info__separator"]}></div>
      <button className={styles["delivery-info__button"]}>
        <FontAwesomeIcon icon={faPlus} className={styles["delivery-info__icon"]}/>
        <span className={styles["delivery-info__span"]}>Add a Delivery Address</span>
      </button>
    </section>
  );
};
